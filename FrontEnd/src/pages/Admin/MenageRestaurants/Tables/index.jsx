...
function Tables() {
  ...
  const Data = [
    ...
    { id: 1, name: "Pizza House", capacity: "4", restaurant: "	Mr Beast Burger", status: "Open", },
    { id: 2, name: "Burger King", capacity: "6", restaurant: "	Mr Beast Burger", status: "Closed", },
